...
`               <p>The total testing time is 30 minutes, and each question has a fixed response time that is shown with a timer. If the test taker does not respond to the question, the next question appears automatically at the end of the available time. In order to maximize the accuracy of each individual’s score and placement decision, the test is adaptive. Test takers first complete an initial set of questions. Then, based on the accuracy of their responses, they are presented a second set of questions adapted to their likely proficiency range.</p>
                <div class="row">
