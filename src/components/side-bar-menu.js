  ...
  render() {
    return (
      ...
      <>
        ...
        <ul className="mt-4">
          <li className="list-1 sidebar-nav-link current-selection" onClick={displayfig1}><a href="#0">All test
            takers</a></li>
          <li className="list-2 sidebar-nav-link" onClick={displayfig2}><a href="#0">Compare: between grades</a></li>
          <li className="list-3 sidebar-nav-link" onClick={displayfig3}><a href="#0">Compare: between class
            (within-grade)</a></li>
          <li className="list-4 sidebar-nav-link" onClick={displayfig4}><a href="#0">Compare: between courses</a></li>
          <li className="list-5 sidebar-nav-link" onClick={displayfig5}><a href="#0">Compare: between teachers
            (within-grade)</a></li>
        </ul>

        <p><i>Only group size >=25 are illustrated</i></p>

        <p className="mt-2"><i>For a more detailed explanation of ELC Entry Scoring, please read our <Link
          to="/app/scoring"> Score Calculation </Link>section.</i></p>
