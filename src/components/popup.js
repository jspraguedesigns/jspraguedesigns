      ...
      <div className="container insidepop">
        <div className="row">
          <div className="col-md-12">
            ...
            <br/>
            <p className="white">We are currently in the process of developing the User Experience of the ELC program.
              Your feedback is critical at this early development stage.</p>
            <p className="white">Please take a moment to look our newly designed interface. Please click on
              our <strong>Comments</strong> tab to let us know what you think.</p>

            <p className="white">As you navigate through this section, imagine your school just completed the ELC Entry,
              click on the <strong>Comments</strong> tab on the right and tell us:
              <ol>
