        ...
        <div className="test-day">
          <div className="row mt-4">
            ...
            <div className="mobile warning">
              <strong>Your device is not supported. To launch the placement test, login using a Windows PC with a
                Windows 7, 8.1 or 10 operating system, or a Macintosh with a Mac OS X v10.12 or higher operating
                system.</strong>
            </div>
          </div>
          <div className="row d-flex justify-content-center mt-4">
              ...
              <div className="w-100 p-2 d-flex align-items-center">
                <div className="instruction">
                  <div className="mr-auto">
                    ...
                    <h5>Step 3:</h5>
                    <p>Locate the test launch file titled elcTestStart.seb inside your computer's Download
                      folder.<br/> Drag and drop the file onto the desktop.</p>
                  </div>
            ...
            <div className="col-md-12 border d-flex align-items-stretch step p-2 pl-4 pr-4">
              <div className="w-100">
                <div>
                  <h5>Step 5:</h5>
                  <p>Enter the Tech Check login ID provided to you by your school’s ELC Assessment
                    Coordinator.<br/> This will log you into the Tech Check. Complete the Tech Check.</p>
                </div>
              </div>
            </div>
        ...
        <div className="test-day mt-4 mb-4">
          <div className="row pb-4">
            <div className="col-md-12 text-center">
              ...
              <p><strong>Proctor: </strong><i>Confirm that you have login ID for all students taking the test today.</i>
              </p>

              <p><i>Download and print: <a target="_blank" href={pdf}>Student Activity Sheet</a> and <a target="_blank"
                                                                                                        href={pdf2}>Student
                Problem Report</a></i></p><br/>
          ...
          <div className="row d-flex">
            <div className="col-md-12 border d-flex align-items-center step p-2 p-2 pl-4 pr-4">
              ...
              <div className="icon-box text-center">
                <img className="icon-pic" src={icon} alt="icon"/>
                <br/>
                <small><i>Launch icon depicted above</i></small>
              </div>
          ...
          <p><strong>At the end of the testing session, return all Student Activity and Problem Reports to your school's
            Assessment Coordinator.</strong></p>
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="testing-req mt-4">
                <div className=" head-btn text-center d-flex justify-content-between align-items-center"
                     onClick={openOne}>
                  <h5>Secure Testing</h5>
                  <div className="icon"><img className="open-plus" src={plus} alt="open"/></div>
                </div>
              </div>
              ...
              <div className="hidden-2">
                <p>Computer hardware must meet the minimum requirements specified by the manufacturers of the operating
                  system and browser in use. Hardware that exceeds the minimum is recommended for an optimal experience.
                  For computer display, follow these specifications:</p>
                <ul>
                ...
                <ul>
                  ...
                  <li>Boom microphone, on the end of a stiff arm that extends in front of the student’s mouth rather
                    than attached to the headphone cord
                  </li>
              ...
              <div className="testing-req">
                <div className="head-btn text-center  d-flex justify-content-between align-items-center"
                  ...
                  <div className="icon6"><img className="open-plus" src={plus} alt="open"/></div>
                </div>
              </div>
