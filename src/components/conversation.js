    ...
    <div className="Conversation">
      ...
      <div class="row pt-4 pb-4">
        <div class="col-md-12 text-center">
          <p><strong>Directions:</strong> Read the first sentence.Tap the words to make an appropriate response to the
            first sentence.</p>
        </div>
      </div>
      ...
      <div className="row d-flex">
        <div className="col-md-6 ml-auto">
          <div className="from-me" data-wow-delay="1s">
            <p className="phone-sentence">Click the buttons below to form <span id="target" onClick={undo}
                                                                                className="display form-control2"></span>
              <span onClick={undo} className="display form-control2"></span>.
            </p>
          </div>
          <div className="girl">
