...
@Component({
  selector: 'app-cc-refund',
  templateUrl: './cc-refund.component.html',
  styleUrls: ['./cc-refund.component.scss']
})
export class CcRefundComponent implements OnInit {
  ccForm: FormGroup;
  ...
  provinceList: any = CAProvinces;
   ...
   submitcc(dccModal){
     ...
     this.router.navigate(['/confirmation-refund']);
